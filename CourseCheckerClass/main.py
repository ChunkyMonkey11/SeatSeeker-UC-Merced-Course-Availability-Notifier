...
def find_open_sections_per_requested_course(user_info) -> dict:
    """
     Write a function that iterates over user_zero_info and finds open courses for the subject and courseNumber. 
     If the requested class is in that list. Send email. 
